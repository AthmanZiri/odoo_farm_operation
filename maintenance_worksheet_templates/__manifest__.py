# -*- coding: utf-8 -*-
{
    ...
    'data': [
        ...
        'data/maintenance_worksheet_jd_s660_views.xml',
        'data/maintenance_worksheet_bateman_rb15_data.xml',
        'data/maintenance_worksheet_bateman_rb15_views.xml',
        'data/maintenance_worksheet_isuzu_data.xml',
        'data/maintenance_worksheet_isuzu_views.xml',
        'data/maintenance_worksheet_motorbike_data.xml',
        'data/maintenance_worksheet_motorbike_views.xml',
        'data/maintenance_worksheet_jd_5075_data.xml',
        'data/maintenance_worksheet_jd_5075_views.xml',
    ],
    'installable': True,
    'application': False,
    'license': 'OEEL-1',
